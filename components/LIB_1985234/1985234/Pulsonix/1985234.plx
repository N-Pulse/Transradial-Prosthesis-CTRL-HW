...
(library Library_1
	...
	(patternDef "1985234" (originalName "1985234")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 8.000, -3.700) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.25 -9.7) (pt 19.25 -9.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 19.25 -9.7) (pt 19.25 2.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 19.25 2.3) (pt -3.25 2.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.25 2.3) (pt -3.25 -9.7) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "1985234" (originalName "1985234") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/SFDatasheet-2/sf-00059076.pdf")
		(attr "<Component Height>" "13.1")
		(attr "<STEP Filename>" "1985234.stp")
		(attr "<STEP Offsets>" "X=-1.75;Y=-9.7;Z=-0.1")
