...
//19877935/1544201/2.50/4/2/Switch
...
(library Library_1
	...
	(patternDef "TL3305BF160QG" (originalName "TL3305BF160QG")
		(multiLayer
			(pad (padNum 1) (padStyleRef r160_140) (pt -3.600, -1.500) (rotation 90))
			(pad (padNum 2) (padStyleRef r160_140) (pt 3.600, -1.500) (rotation 90))
			(pad (padNum 3) (padStyleRef r160_140) (pt -3.600, 1.500) (rotation 90))
			(pad (padNum 4) (padStyleRef r160_140) (pt 3.600, 1.500) (rotation 90))
		)
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -5.4 3.25) (pt 5.4 3.25) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 5.4 3.25) (pt 5.4 -3.25) (width 0.1))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -4.8 -1.6) (pt -4.8 -1.6) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -4.9, -1.6) (radius 0.1) (startAngle .0) (sweepAngle 180.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -5 -1.6) (pt -5 -1.6) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -4.9, -1.6) (radius 0.1) (startAngle 180.0) (sweepAngle 180.0) (width 0.2))
		)
	)
	(symbolDef "TL3305BF100QG" (originalName "TL3305BF100QG")
	...
	(compDef "TL3305BF100QG" (originalName "TL3305BF100QG") (compHeader (numPins 4) (numParts 1) (refDesPrefix S)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TL3305BF100QG"))
		(attachedPattern (patternNum 1) (patternName "TL3305BF160QG")
			(numPads 4)
			(padPinMap
		...
		(attr "Mouser Part Number" "612-TL3305BF100QG")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/E-Switch/TL3305BF100QG?qs=IKkN%2F947nfDIPwqPQja%252BvQ%3D%3D")
		(attr "Manufacturer_Name" "E-Switch")
		(attr "Manufacturer_Part_Number" "TL3305BF100QG")
		(attr "Description" "TACT, 50mA, 12VDC SPST-NO, Off-(On) Surface Mount")
		(attr "<Hyperlink>" "https://configured-product-images.s3.amazonaws.com/2D/specs/TL3305BF100QG.pdf")
		(attr "<STEP Filename>" "TL3305BF100QG.stp")
