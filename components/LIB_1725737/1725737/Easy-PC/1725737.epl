SamacSys ECAD Model
12977086/1544201/2.50/10/2/Connector
...
(library Library_1
	...
	(patternDef "1725737" (originalName "1725737")
		(multiLayer
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 11.430, 0.000) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.5 -3.1) (pt 24.36 -3.1) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 24.36 -3.1) (pt 24.36 3.1) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 24.36 3.1) (pt -1.5 3.1) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.5 3.1) (pt -1.5 -3.1) (width 0.1))
		)
		(layerContents (layerNumRef 30)
			(line (pt -2.5 4.1) (pt 25.36 4.1) (width 0.1))
		)
		(layerContents (layerNumRef 30)
			(line (pt 25.36 4.1) (pt 25.36 -4.1) (width 0.1))
		)
		(layerContents (layerNumRef 30)
			(line (pt 25.36 -4.1) (pt -2.5 -4.1) (width 0.1))
		)
		(layerContents (layerNumRef 30)
			(line (pt -2.5 -4.1) (pt -2.5 4.1) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.5 3.1) (pt 24.36 3.1) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 24.36 3.1) (pt 24.36 -3.1) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 24.36 -3.1) (pt -1.5 -3.1) (width 0.2))
		)
		(layerContents (layerNumRef 18)
	...
	(symbolDef "1725737" (originalName "1725737")
	...
	(compDef "1725737" (originalName "1725737") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "1725737"))
		(attachedPattern (patternNum 1) (patternName "1725737")
			(numPads 10)
			(padPinMap
		...
		(attr "Mouser Part Number" "651-1725737")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Phoenix-Contact/1725737?qs=W3wJikR1%252BS4TtzjqDk79Bg%3D%3D")
		(attr "Manufacturer_Name" "Phoenix Contact")
		(attr "Manufacturer_Part_Number" "1725737")
		(attr "Description" "Fixed Terminal Blocks 10P 2.54mm 90DEG")
		(attr "Datasheet Link" "https://www.phoenixcontact.com/online/portal/us/?uri=pxc-oc-itemdetail:pid=1725737&library=usen&pcck=P-11-01-05&tab=1&selectedCategory=ALL")
		(attr "Height" "8.65 mm")
	)
